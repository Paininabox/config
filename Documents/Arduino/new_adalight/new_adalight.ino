...
static const uint16_t 
  Num_Leds   =  204;        // strip length
static const uint8_t
  Led_Pin    =  5,         // Arduino data output pin
...
static const uint16_t
  SerialTimeout  = 300;     // time before LEDs are shut off if no data (in seconds), 0 to disable

// --- Optional Settings (uncomment to add)
#define SERIAL_FLUSH         // Serial buffer cleared on LED latch
//#define CLEAR_ON_START     // LEDs are cleared on reset
#define GROUND_PIN 14      // additional grounding pin (optional)
